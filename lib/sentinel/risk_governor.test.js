...
test('evaluateTicketRisk blocks configured orders-per-symbol-per-hour cap', () => {
  const result = evaluateTicketRisk(
    ...
    baseContext({
      ...
      recentTickets: [
        { ...ticket, ticket_id: 'older-1', source_signal_id: 'older-1', processed_at: '2026-06-28T17:15:00Z' },
        { ...ticket, ticket_id: 'older-2', source_signal_id: 'older-2', processed_at: '2026-06-28T17:45:00Z' },
      ],
    }),
  );
...
test('evaluateTicketRisk uses processing time for recent symbol orders and ignores future events', () => {
  const result = evaluateTicketRisk(
    ...
    baseContext({
      ...
      recentTickets: [
        { ...ticket, ticket_id: 'same-run-1', source_signal_id: 'same-run-1', processed_at: '2026-06-28T18:01:00Z' },
        { ...ticket, ticket_id: 'older-1', source_signal_id: 'older-1', processed_at: '2026-06-28T17:30:00Z' },
        { ...ticket, ticket_id: 'future-1', source_signal_id: 'future-1', processed_at: '2026-06-28T18:02:00Z' },
      ],
    }),
  );
