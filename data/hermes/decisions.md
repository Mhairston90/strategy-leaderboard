...
| 2026-06-16T20:10:00Z | claude (for Marcus) | (scoring rule) | pre-registration repeal | done | Marcus directed 2026-06-16: contest score = top-5 forward P&L per camp; ONLY backtested/pre-live-start trades excluded; every forward strategy eligible regardless of source (local/bull-github/sheet). Repealed the 2026-06-10 pre-registration model (which hid BULL v0 + Basket Breakout Aggressive v1 behind a stale 06-10 snapshot + remote-source exclusion). Applied SYMMETRICALLY to all camps (OPUS/CODEX/FABLE). scoring_registrations.js emptied (history preserved in HISTORICAL_REGISTRATIONS_REPEALED); contest.js + tests updated; 174/174 green. | Opus/BULL top-5 now: Basket BO Aggressive v1 $1998, BULL v0 $495, BULL v0.12 $491, Stocks MR v2 RSI<15 $404, Stocks MR v2 $132 = $3520. CODEX $4063 (leads). FABLE $99. |
