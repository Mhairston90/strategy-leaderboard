# CODEX Equities Near-Breakout Pullback v1 Portfolio State

> Rebuilt from `memory/equities_near_breakout_pullback_trade_log.md`.
...
|--------|------------------|----------|--------------|---------------|-------|
| equities_near_breakout_pullback | $0.00 | $0.00 | $0.00 | 0 | $0.00 |
| cash | $10,000.00 | $0.00 | $0.00 | 0 | $0.00 |

## Active guardrail state

- Gross exposure: **0.00%** (cap 80%)
- Largest asset exposure: **0.00%** (cap 25%)
- Largest sleeve exposure: **0.00%** (cap 80%)
