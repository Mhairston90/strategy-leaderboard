...
> Generated: 2026-05-29T13:55:01Z
...
|------------|--------|----------|-------------------|-------------------|-------------|------------|------------|--------|------------|----------|
| aggro | CODEX Aggro Foundry | reject | aggro_bank_move_threshold_0.90 | aggro_bank_move_threshold_0.90 | +0.00 | -27.47% | 39.63% | 0.11 | 214 | OOS PF below gate (0.11 < 1.20); OOS drawdown above gate (39.63% > 12.00%); OOS return is not positive (-27.47%); score delta +0.00 below 0.50 |
...
| regime_wfo | CODEX Regime WFO Foundry | reject | regime_bank_vol_skip_threshold_0.90 | regime_bank_vol_skip_threshold_0.90 | +0.00 | -2.13% | 4.98% | 0.08 | 16 | OOS trades below gate (16 < 30); OOS PF below gate (0.08 < 1.20); OOS return is not positive (-2.13%); score delta +0.00 below 0.50 |
