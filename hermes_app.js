...
const PATHS = {
  ...
  itemTracker: 'data/hermes/item_tracker.json',
  decisions: 'data/hermes/decisions.md',
...
async function loadMonitor() {
  ...
  const [
    ...
    fetchLocalText(PATHS.itemTracker),
    fetchLocalText(PATHS.decisions),
  ...
  const model = buildHermesMonitorModel({
    ...
    itemTrackerText: itemTrackerResp.ok ? itemTrackerResp.text : '',
    decisionsText: decisionsResp.ok ? decisionsResp.text : '',
